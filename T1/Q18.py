...
def Q18():
    ...
    b = (
        (math.factorial(20) / (math.factorial(5) * math.factorial(15)))
        * (math.factorial(15) / (math.factorial(5) * math.factorial(10)))
        * (math.factorial(10) / (math.factorial(5) * math.factorial(5)))
    ) / math.factorial(4)

    c = (
        (math.factorial(20) / (math.factorial(6) * math.factorial(14)))
        * (math.factorial(14) / (math.factorial(6) * math.factorial(8)))
        * (math.factorial(8) / (math.factorial(6) * math.factorial(2)))
    ) / math.factorial(3)
